...
$consulta = "SELECT * FROM w_concepto WHERE estado_concepto=1 ORDER BY id_concepto";
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $dat['clave_concepto'] ?></td>
                            ...
                            <div class="modal-body row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group input-group-sm">
                                        ...
                                        <input type="hidden" class="form-control" name="id" id="id" autocomplete="off" placeholder="ID">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="unidad" id="unidad" autocomplete="off" placeholder="UNIDAD">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group input-group-sm">
...
<script src="fjs/cntaconcepto.js?v=<?php echo (rand()); ?>"></script>
